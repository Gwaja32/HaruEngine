...
import static org.libertywild.libertyengine.LibertyEngine.LOGGER;

public class ConfigManager {
    private static final Path PATH = Path.of("config/liberty_engine/config.json");
    ...
    public static void reload() {
        load();
        LOGGER.info("[LibertyEngine] Config reloaded from disk.");
    }
