...
public class EntityFilter {
    ...
    public static boolean isOptimizationTarget(Entity entity) {
        return (((LibertyEntityAccessor) entity).liberty$getFilterMask() & 1) != 0;
    }

    public static boolean isNoPhysicsTarget(Entity entity) {
        return (((LibertyEntityAccessor) entity).liberty$getFilterMask() & 2) != 0;
    }

    public static boolean isParallelTarget(Entity entity) {
        return (((LibertyEntityAccessor) entity).liberty$getFilterMask() & 4) != 0;
    }
}